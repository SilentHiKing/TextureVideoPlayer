...
import com.hiking.nicevideoplayer.custview.NiceTextureView;
import com.hiking.nicevideoplayer.mediaplayer.HMediaPlayer;
import com.hiking.nicevideoplayer.utils.LogUtil;
import com.hiking.nicevideoplayer.utils.NiceUtil;
 ...
 */
public class HNiceVideoPlayer extends FrameLayout
    ...
    private HMediaPlayer mMediaPlayer;
    ...
    public HNiceVideoPlayer(Context context) {
        this(context, null);
    }

    public HNiceVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }
...
//            NiceVideoPlayerManager.instance().setCurrentNiceVideoPlayer(this);
    ...
    private void initMediaPlayer() {
        if (mMediaPlayer == null) {
            mMediaPlayer = new HMediaPlayer(mPlayerType);
        }
        /*if (mMediaPlayer == null) {
            switch (mPlayerType) {
                case TYPE_NATIVE:
...
//                    ((IjkMediaPlayer)mMediaPlayer).setOption(4, "framedrop", 1L);
    ...
    private HMediaPlayer.HOnPreparedListener mOnPreparedListener
            = new HMediaPlayer.HOnPreparedListener() {
        @Override
    ...
    private HMediaPlayer.HOnVideoSizeChangedListener mOnVideoSizeChangedListener
            = new HMediaPlayer.HOnVideoSizeChangedListener() {
        @Override
    ...
    private HMediaPlayer.HOnCompletionListener mOnCompletionListener
            = new HMediaPlayer.HOnCompletionListener() {
        @Override
    ...
    private HMediaPlayer.HOnErrorListener mOnErrorListener
            = new HMediaPlayer.HOnErrorListener() {
        @Override
    ...
    private HMediaPlayer.HOnInfoListener mOnInfoListener
            = new HMediaPlayer.HOnInfoListener() {
        @Override
